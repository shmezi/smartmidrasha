...
import Widget from "@/app/commander/homes/dash/widget/Widget";
import {IUser, User} from "@/struct/impl/User";
import {AttendanceLog, IAttendanceLog} from "@/struct/impl/AttendanceLog";
import {GeneralAttendanceLog} from "@/struct/impl/GeneralAttendanceLog";
...
const CommanderReviewDash = async () => {
    ...
    const attendanceLogArray: IAttendanceLog[] = await AttendanceLog.find({date: dateToday})
    ...
    const generalAttendanceLog: IAttendanceLog[] = await GeneralAttendanceLog.find({date: dateToday})
